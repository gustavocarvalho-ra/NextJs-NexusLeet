...
export default function CardUserConfg({icon, TextStr, AboutStr}: CardInt) {
  ...
  return (
    <div className="w-[32%] h-36 bg-(--mod) flex flex-col justify-center rounded-lg p-3.5 shadow-lg/20 transition duration-150 ease-in-out  hover:shadow-lg/30 cursor-pointer">
